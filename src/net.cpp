...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "bitnitron " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"178.62.90.103", "178.62.90.103"},
    {"167.99.153.252", "167.99.153.252"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. bitnitron is probably already running."), addrBind.ToString().c_str());
        else
